...
do_cmake_linux:
	...
	cmake -G $(GENERATOR_LINUX) \
		  ...
		  -DSJ_ENABLE_DOXYGEN=$(ENABLE_DOXYGEN_LINUX) \
		  -DSJ_ENABLE_BUILD_TESTS=$(ENABLE_BUILD_TESTS_LINUX) \
		  -DSJ_ENABLE_COVERAGE_REPORT=$(ENABLE_COVERAGE_REPORT_LINUX) \
		  -DSJ_ENABLE_BUILD_EXAMPLES=$(ENABLE_BUILD_EXAMPLES_LINUX) \
		  -DSJ_ENABLE_CALLGRIND_TARGETS=$(ENABLE_CALLGRIND_LINUX) \
		  -DSJ_ENABLE_STATIC_ANALYSIS=$(ENABLE_STATIC_ANALYSIS_LINUX) \
		  -DSJ_ENABLE_BRUTAL_COMPILE_OPTIONS=$(ENABLE_BRUTAL_COMPILE_OPTIONS_LINUX) \
		  -DSJ_ENABLE_SANITIZERS=$(ENABLE_SANITIZERS_LINUX) \
		  .. && \
	cmake --build . && \
...
do_cmake_windows_vs:
	...
	cmake -G $(GENERATOR_WINDOWS) \
		  -DSJ_ENABLE_DOXYGEN=$(ENABLE_DOXYGEN_WINDOWS) \
		  -DSJ_ENABLE_BUILD_TESTS=$(ENABLE_BUILD_TESTS_WINDOWS) \
		  -DSJ_ENABLE_COVERAGE_REPORT=$(ENABLE_COVERAGE_REPORT_WINDOWS) \
		  -DSJ_ENABLE_BUILD_EXAMPLES=$(ENABLE_BUILD_EXAMPLES_WINDOWS) \
		  -DSJ_ENABLE_CALLGRIND_TARGETS=$(ENABLE_CALLGRIND_WINDOWS) \
		  -DSJ_ENABLE_STATIC_ANALYSIS=$(ENABLE_STATIC_ANALYSIS_WINDOWS) \
		  -DSJ_ENABLE_BRUTAL_COMPILE_OPTIONS=$(ENABLE_BRUTAL_COMPILE_OPTIONS_WINDOWS) \
		  -DSJ_ENABLE_SANITIZERS=$(ENABLE_SANITIZERS_WINDOWS) \
		  .. && \
